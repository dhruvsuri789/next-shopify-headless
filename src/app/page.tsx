          ...
          <div className="grid max-w-[1300px] mx-auto gap-4 px-4 sm:px-6 md:px-10 md:grid-cols-2 md:gap-16">
            ...
            <div className="flex flex-col items-start space-y-4">
              ...
              <div className="flex flex-col w-full md:flex-row gap-2 text-nowrap">
                ...
                <Link
                  href="/search/sales"
                  className="inline-flex h-9 items-center justify-center rounded-md border border-blue-300 border-input bg-background px-4 py-2 text-sm font-medium shadow-sm transition-colors hover:bg-blue-700 hover:text-white focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
                  prefetch={false}
                >
                  Shop Sales
                </Link>
          ...
          <div className="mx-auto grid items-start justify-center gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-4">
            <div className="grid gap-1">
              ...
              >
                ...
                />
                <h3 className="mt-4 text-center text-lg font-bold group-hover:underline">
                  Women&apos;s Collection
                </h3>
              </Link>
            </div>
